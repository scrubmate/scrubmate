...
function updateScrubProfileDeviceToken(){

  const tokenCard =
    document.getElementById(
      "scrubProfileTokenCard"
    );

  const tokenValue =
    document.getElementById(
      "scrubProfileTokenValue"
    );

  const tokenStatus =
    document.getElementById(
      "scrubProfileTokenStatus"
    );
